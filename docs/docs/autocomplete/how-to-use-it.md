...
Autocomplete provides inline code suggestions as you type. To enable it, simply click the "Daemonium-Core" button in the status bar at the bottom right of your IDE or ensure the "Enable Tab Autocomplete" option is checked in your IDE settings.
